...
public class Consignee implements BaseObject {
	...
	public Consignee(String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8, String s9, String s10, String s11) {
		this.sConsId = s1;
		this.sName = s2;
		this.sCity = s3;
		this.sProv = s4;
