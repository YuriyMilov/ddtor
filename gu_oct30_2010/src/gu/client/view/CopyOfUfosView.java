...
public class CopyOfUfosView extends Composite implements ObjectFactoryListener {
	...
	public CopyOfUfosView() {
		...
		RootPanel
				.get()
				.add(new HTML(
						"<br>&nbsp;&nbsp;test@quicklydone.com | <b><a href=\".\">Logout</a></b><br><br>"));
	...
	/*
	 * public void setMainPane(Widget view) { vp2.clear();
	 * vp2.removeFromParent(); vp2.add( view ); mainPanel.add(vp2); }
	 * 
	 * public void setMainPaneLoading() { vp2.clear(); vp2.removeFromParent();
	 * vp2.add(loadingLabel); mainPanel.add(vp2); }
	 */
		...
		srv.getData("all", new AsyncCallback<String[][]>() {
			...
			public void onSuccess(String[][] r2) {
				...
				for (int j = 0; j < r2.length; j++) {
					String[] ccn = new String[] { r2[j][4], r2[j][5], r2[j][6],
							r2[j][7], "", "", "", "", r2[j][8], r2[j][9],
							r2[j][10], r2[j][11], r2[j][12], r2[j][13],
							r2[j][14], r2[j][15], r2[j][16], r2[j][17],
							r2[j][18], r2[j][19], r2[j][20], r2[j][21] };
					if (!r2[j][5].equals("0"))
						ar2.add(ccn);
					String[] ccn2 = new String[] { r2[j][0], r2[j][1],
							r2[j][2], r2[j][3], "", "", "", "", r2[j][8],
							r2[j][9], r2[j][10], r2[j][11], r2[j][12],
							r2[j][13], r2[j][14], r2[j][15], r2[j][16],
							r2[j][17], r2[j][18], r2[j][19], r2[j][20],
							r2[j][21] };
					if (!r2[j][5].equals("0"))
						ar2.add(ccn2);
				}
