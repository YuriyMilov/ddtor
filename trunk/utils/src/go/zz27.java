...
h=h.substring(7);
h=h.substring(0,h.indexOf(".")-4);
//sta.wtft(h, "servlet/test/"+id+".txt");
				...
				System.out.println("\r\n\r\n   Exception pause 5 min.  \r\n");
				System.out.println(com.google.gdata.util.common.html.HtmlToText.htmlToPlainText(e.toString()));
