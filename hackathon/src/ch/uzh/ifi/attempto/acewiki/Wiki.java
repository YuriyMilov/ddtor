...
public class Wiki implements ActionListener, ExternalEventListener {
	...
	Wiki(Backend backend, Map<String, String> parameters, int sessionID) {
		...
		navigationButtons.setBackground(Styleqq.shadedBackground);
		...
		sideBar.setBackground(Styleqq.shadedBackground);
		...
		if (isReadOnly()) {
			...
			rolabel.setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(10)));
		...
		label1.setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(10)));
		sideCol.add(label1);
		...
		label2.setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(10)));
		sideCol.add(label2);
	...
	public static ResourceImageReference getImage(String fileName) {
		return Styleqq.getImage("ch/uzh/ifi/attempto/acewiki/gui/img/" + fileName);
	}
