...
public class StatementMenu extends Row implements ActionListener {
	...
	public void addMenuEntry(String text, String tooltip) {
		...
		menuEntry.setBackground(Styleqq.mediumBackground);
		menuEntry.setForeground(Styleqq.darkForeground);
		menuEntry.setRolloverEnabled(true);
		menuEntry.setRolloverForeground(Styleqq.lightForeground);
		menuEntry.setRolloverBackground(Styleqq.darkBackground);
		...
		menuEntry.setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(13)));
	...
	public void addMenuSeparator() {
		...
		menuSeparator.setBackground(Styleqq.mediumBackground);
		Column line = new Column();
		line.setBackground(Styleqq.darkBackground);
