...
public class ExportWindow extends WindowPane implements ActionListener {
	...
	public ExportWindow(Wiki wiki) {
		...
		label.setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(13)));
		...
		listBox.setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(11)));
		listBox.setBackground(Styleqq.lightBackground);
