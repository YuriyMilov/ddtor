...
public class GeneralButton extends Button {
	...
	public GeneralButton(String text, int width, ActionListener actionListener) {
		...
		setDisabledBackground(Styleqq.lightDisabled);
		setDisabledForeground(Styleqq.darkDisabled);
		setDisabledBorder(new Border(1, Styleqq.darkDisabled, Border.STYLE_OUTSET));
		...
		setFont(new Font(Styleqq.fontTypeface, Font.ITALIC, new Extent(13)));
