...
public class RadioButton extends nextapp.echo.app.RadioButton {
	...
	public RadioButton(String text, ImageReference icon, ButtonGroup group) {
		...
		setStateIcon(Styleqq.getImage("ch/uzh/ifi/attempto/echocomp/style/radiooff.png"));
		setSelectedStateIcon(Styleqq.getImage("ch/uzh/ifi/attempto/echocomp/style/radioon.png"));
		setFont(new Font(Styleqq.fontTypeface, Font.PLAIN, new Extent(13)));
	}
