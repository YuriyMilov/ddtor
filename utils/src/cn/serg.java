...
public class serg extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		from=sta.rep(from, " ", "%20");
		to=sta.rep(to, " ", "%20");
			s="from:%20"+from+"%20to:%20"+to;
		System.out.println(sta.rep(s, "%20", " ")+"\r\n\r\n");
		s = sta
				.rfu("http://maps.google.com/maps/nav?key=ABQIAAAACI6Ap2jcQ1oqProEJaR56RQK5EEH2t0xEwQ4uv9AyPUz7NEyYxQvir4iiXU1B5zMsah16FswrqdssA&output=txt&doflg=ptj&hl=en&gl=US&q="+s);
