...
public class _z2b_31 extends Thread {
	public _z2b_31() throws Exception {
		// this.start();
	...
	public static void zin(String zips) throws Exception {
		...
		for (int i = 0; i < f.list().length; i++) {
			...
			ss = sf.substring(sf.indexOf("-") + 1, sf.indexOf("."));
			n = Integer.parseInt(ss);
			System.out.println(n);
			int k = 0;
			while (k++ < n) {
				System.out.println(k);
//				ZipFile zipFile = new ZipFile(new File(zips + "/" + sf));
