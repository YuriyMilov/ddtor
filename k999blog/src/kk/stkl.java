...
public class stkl {
	...
	static void sm(String skomu, String s) throws Exception {
		...
		msg.setFrom(new InternetAddress("k999@quicklydone.com", "К. Тверской"));
	...
	static void smbj(String skomu, String subj,String s) throws Exception {
		Properties props = new Properties();
		Session session = Session.getDefaultInstance(props, null);
		Message msg = new MimeMessage(session);
		msg.setFrom(new InternetAddress("k999@quicklydone.com", "К. Тверской"));
	...
	static void smtxt(String s) throws Exception {
		...
		Session session = Session.getDefaultInstance(props, null);
		Message msg = new MimeMessage(session);
		msg.setFrom(new InternetAddress("k999@quicklydone.com", "Example.com Admin"));
