...
public class del_ship extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Shipper> rd = (List<Shipper>) pm.newQuery("SELECT FROM " + Shipper.class.getName()+ " WHERE sShipId==\""+req.getParameter("ship_id")  +"\"").execute();
		...
		s="Shipper ship_id="+ req.getParameter("ship_id")+" has been successfully deleted";
