...
public class Board implements BaseObject {
	@PrimaryKey
	...
	public Board(String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8, String s9, String s10, String s11, String s12, String s13, String s14, String s15, String s16, String s17, String s18, String s19, String s20) {
		this.wo_number = s1;
		this.ship_id = s2;
		this.cons_id = s3;
	...
	public String get_city_ship() {
		return from_city;
	}
	public void set_city_ship(String from_city) {
		this.from_city = from_city;
	}
	
	@Persistent
	private String from_prov;
	
	public String get_prov_ship() {
		return from_prov;
	}
	public void set_prov_ship(String from_prov) {
		this.from_prov = from_prov;
	}
	
	@Persistent
	private String to_city;	
	public String get_city_cons() {
		return to_city;
	}
	public void set_city_cons(String to_city) {
		this.to_city = to_city;
	}
	
	@Persistent
	private String to_prov;	
	public String get_prov_cons() {
		return to_prov;
	}
	public void set_prov_cons(String to_prov) {
		this.to_prov = to_prov;
	}
